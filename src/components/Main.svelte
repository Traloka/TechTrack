...
svg
  ...
  .attr('r', 8)
  .attr('fill', (d) => statusColors[d.status.abbrev.toLowerCase()],statusColors[d.status.toLowerCase()]) //hier word bepaald welke kleur de stip heeft afhankelijk van de status
